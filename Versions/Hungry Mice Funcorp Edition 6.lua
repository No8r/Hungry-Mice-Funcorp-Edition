...
local langue = {
    ...
    en = {
        ...
        translatedBy  = "Translated into English by: <CH>%s</CH>", ---Translated to your language not translated to English EX: (Translated into Russian by <CH>%s</CH>(in Russian))
    ...
    es = {
        ...
        help_credits  = "<font size='12'>Este module fue creado por <v>Noooooooorr</v></font><g><font size='9'>#0000</font><</g>\n\n<font size='12'><font color='#ffd991'><B>Traducido por:</B></font>",
    ...
    tr = {
        ...
        points      = "<rose> Kullanıcı ismi rengini değiştirmek için 2 tur kazanmalısın. \n • Kullanıcı ismini değiştirmek için 5 tur kazanmalısın.</rose>",
        colorNick   = "İsim rengi",
        changenick  = "Kullanıcı ismi",
        chosencolor = "<fc>[•] Kullanıcı ismi rengin, sonraki turda <font color='#%s'>#%s</font> olarak değişecek.</fc>",
        chosenName  = "<fc>[•] Kullanıcı ismin, sonraki turda <r><b>%s</b></r> olarak değişecek.</fc>",
        waitAMoment = "<fc>[•] Yeniden istekte bulunmak için %s saniye beklemelisin",
        youRadmin   = "<J>Artık adminsin!<J>",
        isAdmin     = "<J>%s artık admin!<J>",
        youAre      = "<fc><b>%s</b>'e döndün!<fc>",
        returnMice  = "<fc>Normal fareye döndün!</fc>",
    },
    hu = {
    ...
    ro = {
        ...
        points      = "<rose> • Pentru a-ți schimba culoarea numelui, trebuie să câștigi 2 runde.\n • Pentru a-ți schimba numele, trebuie să câștigi 4 runde.</rose>",
        colorNick   = "Culoarea numelui",
        changenick  = "Schimbă-ți numele",
        chosencolor = "<fc>[•] Culoarea numelui tău va fi schimbată în <font color='#%s'>#%s</font> începând de runda viitoare.</fc>",
        chosenName  = "<fc>[•] Numele tău va fi schimbat în <r><b>%s</b></r> începând de runda viitoare.</fc>",
        waitAMoment = "<fc>[•] Trebuie să aștepți %s secunde pentru a putea folosi iar comanda.",
        youRadmin   = "<J>Acum ești admin!<J>",
        isAdmin     = "<J>%s este acum un admin!<J>",
        youAre      = "<fc>Te-ai transformat într-o/un <b>%s</b>!<fc>",
        returnMice  = "<fc>Te-ai reîntors șoarecele normal.</fc>",
        ...
        update1              = "<FC><B> • </B></FC><FC>Meniul Mice sizes! :</FC> apasă [SHIFT] pentru a vedea mărimea celorlalți șoareci.\n<FC><B> • </B></FC>Dacă te blochezi în/pe pămâne, poți apăsa tasta M pentru a reînvia (fără a-ți pierde progresul). Poți folosi doar o singură dată pe rundă.\n<FC><B> • </B></FC>Au fost schimbate mărimea și poziția banner-ului.\n<FC><B> • </B></FC>Diferite erori fixate.",
    },
    ru = {
